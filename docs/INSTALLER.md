...
## Purpose
`v3.1.3` preserves the installed-first Windows utility model and refines the runtime UI into a fixed-size CustomTkinter shell with High-Contrast Black + Purple styling.
...
```text
dist\PaliaHotpotReminder-Setup-v3.1.3.exe
dist\PaliaHotpotReminder-Setup-v3.1.3.exe.sha256
```
