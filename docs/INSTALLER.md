...
## Purpose
`v3.1.2` preserves the installed-first Windows utility model and refines the runtime UI into a fixed-size CustomTkinter shell with High-Contrast Black + Purple styling.
