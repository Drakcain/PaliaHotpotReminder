...
- Primary artifact: `PaliaHotpotReminder-Setup-v3.1.1.exe`
- Checksum artifact: `PaliaHotpotReminder-Setup-v3.1.1.exe.sha256`
...
For `v3.1.1`, publish these release assets:
