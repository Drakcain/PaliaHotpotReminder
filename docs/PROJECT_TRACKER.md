...
## v3.1.5 Installer Validation Hardening
...
- Target artifact is `PaliaHotpotReminder-Setup-v3.1.5.exe`.
...
## Current Task
The active pass is `v3.1.5`: installer validation hardening and Python 3.12 resolution hardening on
