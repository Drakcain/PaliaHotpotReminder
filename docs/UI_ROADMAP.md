...
This document tracks the current HPR UI rules and the v3.1.3 fixed-window modular
...
The v3.1.3 direction is a black/purple desktop dashboard inspired by the official
